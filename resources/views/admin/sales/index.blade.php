...
<div class="page-header">
    <div class="page-header-title">
        ...
        <span>This Shows all the existing sale tranasaction executed by staff of Anaebo Global Service Limited</span>
    </div>
                    ...
                    <div class="col-md-4">
                        <div class="row text-center">
                            <div class="col-sm-12 invoice-btn-group">
                                <a href="{{route('account.sales.create.start')}}">
                                ...
                                @foreach($sales as $sale)
                                    <tr>
                                        ...
                                        <td class="action-icon">
                                            ...
                                            <a href="{{route('account.sales.edit',  ['id' => $sale->id])}}" class="m-r-15 text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="icofont icofont-ui-edit"></i></a>
