...
<div class="page-header">
    <div class="page-header-title">
        ...
        <span>This Shows all the Salary Types inserted over time</span>
    </div>
    <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">Salary Types Categories</a>
            </li>
        </ul>
    </div>
</div>
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header table-card-header">
                    <h5>All Salary Types Categories</h5>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="row text-center">
                            <div class="col-sm-12 invoice-btn-group">
                                <a href="{{route('salary-structure.create')}}">
                                    <button  type="button" class="btn btn-primary btn-print-invoice waves-effect waves-light m-r-20">Add New Salary Structure
                                    </button>
                                </a>
                                <a href="{{route('home')}}" >
                ...
                <div class="card-block">
                    <div class="dt-responsive table-responsive">
                         <table id="footer-search" class="table table-striped table-bordered nowrap">
                            <thead>
                                <tr>
                                    <th>Salary Issue Date</th>
                                    <th>Salary Types Category</th>
                                    <th>Action</th>                             
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($settings as $setting)
                                    <tr>
                                        ...
                                        <td class="action-icon">
                                            <a href="{{route('salary-structure.show', ['id' => $setting->id])}}" class="m-r-15 text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="View"><i class="icofont icofont-eye-alt"></i></a>
                                            <a href="{{route('salary-structure.edit',  ['id' => $setting->id])}}" class="m-r-15 text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="icofont icofont-ui-edit"></i></a>
                                            <a href="{{route('salary-structure.delete',  ['id' => $setting->id])}}" class=" text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="icofont icofont-delete-alt"></i></a>
                                        </td>
                                    </tr>
                                 @endforeach
                            </tbody>
