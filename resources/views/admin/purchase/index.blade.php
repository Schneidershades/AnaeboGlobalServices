...
<div class="page-header">
    <div class="page-header-title">
        <h4>Stocks Transaction Purchased</h4>
        <span>This Shows all the Stocks Purchased available to the Admin</span>
    </div>
    <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">Stocks Purchased</a>
            </li>
        </ul>
    </div>
</div>
                    ...
                    <div class="col-md-4">
                        <div class="row text-center">
                            <div class="col-sm-12 invoice-btn-group">
                                <a href="{{route('account.purchases.create.start)}}">
                                    <button  type="button" class="btn btn-primary btn-print-invoice waves-effect waves-light m-r-20">Add New Stock Purchase
                                    </button>
                                </a>
                                <a href="{{route('home')}}" >
                                ...
                                @foreach($purchases as $purchase)
                                    <tr>
                                        ...
                                        <td class="action-icon">
                                            <a href="{{route('purchase.show', ['id' => $purchase->id])}}" class="m-r-15 text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="View"><i class="icofont icofont-eye-alt"></i></a>
                                            <a href="{{route('purchase.edit',  ['id' => $purchase->id])}}" class="m-r-15 text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="icofont icofont-ui-edit"></i></a>
                                            <a href="{{route('purchase.delete',  ['id' => $purchase->id])}}" class=" text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="icofont icofont-delete-alt"></i></a>
                                        </td>
                                    </tr>
                                 @endforeach
                            </tbody>
