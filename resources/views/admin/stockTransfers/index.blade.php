                        ...
                        <div class="row text-center">
                            <div class="col-sm-12 invoice-btn-group">
                                <a href="{{route('stock.transfer.create')}}">
                                    <button  type="button" class="btn btn-primary btn-print-invoice waves-effect waves-light m-r-20">Add Stock Quantities
                                    </button>
                                </a>
                                <a href="{{route('home')}}" >
                                ...
                                @foreach($transfers as $transfer)
                                    <tr>
                                        ...
                                        <td class="action-icon">
                                            <a href="{{route('stock.transfer.show', ['id' => $transfer->id])}}" class="m-r-15 text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="View"><i class="icofont icofont-eye-alt"></i></a>
                                            <a href="{{route('stock.transfer.edit',  ['id' => $transfer->id])}}" class="m-r-15 text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="icofont icofont-ui-edit"></i></a>
                                            <a href="{{route('stock.transfer.delete',  ['id' => $transfer->id])}}" class=" text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="icofont icofont-delete-alt"></i></a>
                                        </td>
                                    </tr>
                                 @endforeach
                            </tbody>
