...
@section('content')
    ...
    <div class="page-header">
        <div class="page-header-title">
            <h4>Create Stock Transfer Transaction on Transfer No: {{$transfer->identifier}}</h4>
            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <div class="wrapper">
                            <form action="{{ route('account.transfers.store', [ 'id' => $transfer->id ]) }}" method="post">
                                <div class="row invoice-contact">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <select class="js-example-basic-single form-control" name="branch_id_from" required>
                                            ...
                                            <div class="col-sm-4">
                                                 <select class="js-example-basic-single form-control" name="branch_id_to" required>
