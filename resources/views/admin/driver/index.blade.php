...
<div class="page-header">
    <div class="page-header-title">
        <h4>Industry Drivers</h4>
        <span>This Shows all the existing Drivers to Anaebo Global Service Limited</span>
    </div>
    <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">Drivers</a>
            </li>
        </ul>
    </div>
</div>
                                ...
                                @foreach($drivers as $branch)
                                    <tr>
                                        ...
                                        <td class="action-icon">
                                            <a href="{{route('drivers.show', ['id' => $driver->id])}}" class="m-r-15 text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="View"><i class="icofont icofont-eye-alt"></i></a>
                                            <a href="{{route('drivers.edit',  ['id' => $driver->id])}}" class="m-r-15 text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="icofont icofont-ui-edit"></i></a>
                                            <a href="{{route('drivers.delete',  ['id' => $driver->id])}}" class=" text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="icofont icofont-delete-alt"></i></a>
                                        </td>
                                    </tr>
                                 @endforeach
                            </tbody>
